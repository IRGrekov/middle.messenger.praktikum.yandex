...
interface IAvatar_mini extends IAvatarProps {
  avatar: string;
  events: {
    change: Function;
  };
}
export class Avatar_mini extends Block<IAvatar> {
  ...
  render() {
    ...
    <input class="profile__avatar_previewn" type="file" id="file" >
     <img width="130px" height="130px" class="profile__avatar_img" src=${avatarURL}>
